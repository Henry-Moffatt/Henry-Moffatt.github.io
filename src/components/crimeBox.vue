...
<template>
  <div class="crime">
    <h1>{{finData.primary_type}}</h1>
    <h2>{{finData.description}}</h2>
    <p>{{finData.location_description}}</p>
    <p>Date: {{finData.date.slice(0,10)}}</p>
  </div>
...
<style>
.crime {
  border: 5px solid rgba(255,210,255,1);
  border-radius: 10px;
  margin: 10px;
